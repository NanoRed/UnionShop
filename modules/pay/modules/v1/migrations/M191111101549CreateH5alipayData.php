...
/**
 * Class M191111101549CreateH5alipayData
 */
class M191111101549CreateH5alipayData extends Migration
{
    private $paymentName = '支付宝H5支付';
    private $paymentAlias = 'h5alipay';
    ...
    public function safeUp()
    {
        ...
        // 获取配置
        $config = require __DIR__ . '/../payments/h5alipay/libs/config/params.php';
    ...
    {
        echo "M191111101549CreateH5alipayData cannot be reverted.\n";
