...
class OrderItemFixture extends BaseActiveFixture
{
    public $modelClass = 'app\modules\order\modules\v1\models\OrderItem';
    public $dataFile = '@app/tests/unit/fixtures/data/order_items.php';
