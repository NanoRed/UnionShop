...
class OrderShippingFixture extends BaseActiveFixture
{
    public $modelClass = 'app\modules\logis\modules\v1\models\OrderShipping';
    public $dataFile = '@app/tests/unit/fixtures/data/order_shipping.php';
